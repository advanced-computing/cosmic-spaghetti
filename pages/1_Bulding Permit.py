...
def get_permits():
    credentials = service_account.Credentials.from_service_account_info(
        st.secrets["gcp_service_account"], scopes=["https://www.googleapis.com/auth/bigquery"]
    )
...
with display_load_time():
    ...
    bucket = st.selectbox(
        "Time bucket", ["Monthly", "Weekly", "Daily"], index=0, key="bucket_permits"
    )  # noqa: E501
